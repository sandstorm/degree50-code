...
import {
  AttachmentViewerStateSlice,
  selectActiveAttachment,
  setActiveAttachment,
} from './AttachmentViewerSlice'
import Button from 'Components/Button/Button'

const mapStateToProps = (
  state: ConfigStateSlice & AttachmentViewerStateSlice
) => ({
    ...
    return (
      ...
      >
        <div className={'tile__content'}>
          <i
            className={`tile__icon fas fa-${mapAttachmentTypeToIcon(
              attachment.type
            )}`}
          ></i>
