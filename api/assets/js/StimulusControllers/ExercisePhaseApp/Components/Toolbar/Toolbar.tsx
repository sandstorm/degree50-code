...
export type Component = {
  ...
  onClick: (
    ...
    component: Component,
    config: ConfigState,
    closeComponent: boolean
  ) => void
}

type ToolbarProps = ReturnType<typeof mapStateToProps> &
...
const Toolbar: React.FC<ToolbarProps> = (props) => {
  ...
  const toggleComponentWrapper = (component: Component) => {
    ...
    component.onClick(
      ...
      component,
      props.config,
      props.activeToolbarItem === component.id
    )
  ...
  const toolbarItemsToRender = possibleComponentsForToolbar
    .filter(
      (component) =>
        props.config.components.includes(component.id) || component.isMandatory
    )
  ...
  return (
    <div
      className={
        props.isVisible === true ? 'toolbar toolbar--is-visible' : 'toolbar'
      }
    >
      <button
