...
type Props = {
    ...
    videoCodes: Array<{ start: string; end: string; text: string; color: string | null }>
    videos: Array<{ url: string }>
    updateSubtitles: (elements: Array<Subtitle>) => void
    updateVideoCodes: (elements: Array<Subtitle>) => void
}
