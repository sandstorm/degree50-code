...
export default function(props) {
    ...
    if (config.videoCodes.length === 0) {
        videoCodes = <div className={'video-code'} style={{backgroundColor: '#ccc'}}><span>Es stehen keine Video-Codes zur Auswahl für diese Aufgabe</span></div>
    } else {
        videoCodes = config.videoCodes
            .map((videoCode) => (
