...
import VideoPlayerWrapper, {
  Video,
} from '../../../../Components/VideoPlayer/VideoPlayerWrapper'
...
import {
  AppState,
  AppDispatch,
} from 'StimulusControllers/ExerciseAndSolutionStore/Store'
...
const mapDispatchToProps = (dispatch: AppDispatch) => ({
  setOverlayVisibility: (isVisible: boolean) =>
    dispatch(setOverlayVisibility(isVisible)),
})

type OverlayProps = ReturnType<typeof mapStateToProps> &
...
const Overlay: React.FC<OverlayProps> = (props) => {
  ...
  const className =
    props.isVisible === true ? 'overlay overlay--is-visible' : 'overlay'
  return (
    <div className={className + ' ' + sizeClass}>
      ...
      <div className={'overlay__content'}>
        {renderOverlayComponent(props.component, props.videos)}
      </div>
    </div>
  )
}
