...
const FinishReviewMenu = () => {
  const needsReview = useAppSelector(
    selectors.data.selectMaterialSolutionNeedsReview
  )
  const selectedSolutionId = useAppSelector(
    selectors.data.materialSolution.selectSelectedSolutionId
  )
