...
const mapStateToProps = (state: AppState) => {
  return {
    ...
    allMediaItemsAsRichtext:
      selectors.selectAllMediaItemsByStartTimeAsRichtext(state),
    isMaterialPhase:
      selectors.config.selectPhaseType(state) ===
      ExercisePhaseTypesEnum.MATERIAL,
  }
}
        ...
        {allMediaItems.map((mediaItem, index) => {
          ...
          switch (mediaItem.type) {
            ...
            case MediaItemTypeEnum.cut: {
              return (
                <CutListItem key={key} cutId={mediaItem.id} index={index} />
              )
            }
