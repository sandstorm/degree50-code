...
export const useShortCuts = () => {
   ...
   */
  // togglePlay
  const togglePlayHotKey = useAppSelector((state) =>
    selectHotKeyByShortCutId(state, ShortCutId.TOGGLE_PLAY)
  )
  useHotkeys(
    togglePlayHotKey,
    (keyboardEvent) => {
  ...
  // createVideoCode
  const createVideoCutHotKey = useAppSelector((state) =>
    selectHotKeyByShortCutId(state, ShortCutId.CREATE_VIDEO_CUT)
  )
  useHotkeys(
