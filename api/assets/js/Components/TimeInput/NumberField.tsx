...
const NumberField = (props: Props) => {
  ...
  const { incrementButtonProps, decrementButtonProps, groupProps, inputProps } =
    useNumberField({ 'aria-label': props['aria-label'] }, state, inputRef)
  ...
  return (
    <div className="number-field">
      <div className="group" {...groupProps}>
        <button
          className="number-field__inc-button"
          {...incrementProps}
          ref={incrRef}
        >
        ...
        <button
          className="number-field__dec-button"
          {...decrementProps}
          ref={decRef}
        >
