...
describe('Medialane item', () => {
  ...
  it('should open correct annotation overlay on click on info icon', async () => {
    ...
    expect(
      await waitFor(() => screen.getByText(/Test-Annotation Memo/i))
    ).toBeVisible()
  ...
  it('should open correct videoCode overlay on click on info icon', async () => {
    ...
    expect(
      await waitFor(() => screen.getByText(/Test-VideoCode Memo/i))
    ).toBeVisible()
    expect(
      await waitFor(() => screen.getByText(/Video Codierung/i))
    ).toBeVisible()
  ...
  it('should open correct cut overlay on click on info icon', async () => {
    ...
    expect(
      await waitFor(() => screen.getByText(/Test-Cut Memo/i))
    ).toBeVisible()
