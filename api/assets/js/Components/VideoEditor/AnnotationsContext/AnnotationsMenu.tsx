...
const mapStateToProps = (state: AppState) => {
  ...
  const annotationsAreActive =
    selectors.config.selectAnnotationsAreActive(state)
  ...
  return {
    allAnnotationsCount:
      selectors.selectAllAnnotationIdsByStartTime(state).length,
    activeAnnotationCount:
      selectors.selectAllActiveAnnotationIdsAtCursor(state).length,
    disableCreate,
    disabled,
  }
}
