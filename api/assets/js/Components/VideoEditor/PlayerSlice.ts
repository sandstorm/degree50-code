...
const selectPlayPosition = (state: PlayerStateSlice) =>
  state.videoEditor.player.playPosition
const selectSyncPlayPosition = (state: PlayerStateSlice) =>
  state.videoEditor.player.syncPlayPosition
const selectIsPaused = (state: PlayerStateSlice) =>
  state.videoEditor.player.isPaused
