...
const ShortCutSoundsSlice = createSlice({
  ...
  reducers: {
    setShortCutSoundsState: (
      state: ShortCutSoundState,
      action: PayloadAction<ShortCutSoundState>
    ) => action.payload,
    setIsSoundEnabled: (
      state: ShortCutSoundState,
...
export const { setIsSoundEnabled, setShortCutSoundsState } =
  ShortCutSoundsSlice.actions

export const selectShortCutSoundState = (state: {
  shortCutSoundOptions: ShortCutSoundState
}) => state.shortCutSoundOptions
export const selectIsSoundEnabled = (state: {
  shortCutSoundOptions: ShortCutSoundState
