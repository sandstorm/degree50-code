...
export const SolutionSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        annotationsSlice.actions.remove,
        (state, action: PayloadAction<AnnotationId>) => {
          if (!state.current) {
            return state
          }
      ...
      .addCase(
        videoCodesSlice.actions.append,
        (state, action: PayloadAction<VideoCode>) => {
          if (!state.current) {
            return state
          }
      ...
      .addCase(
        videoCodesSlice.actions.remove,
        (state, action: PayloadAction<VideoCodeId>) => {
          if (!state.current) {
            return state
          }
      ...
      .addCase(
        cuttingSlice.actions.append,
        (state, action: PayloadAction<Cut>) => {
          if (!state.current) {
            return state
          }
      ...
      .addCase(
        cuttingSlice.actions.remove,
        (state, action: PayloadAction<CutId>) => {
          if (!state.current) {
            return state
          }
      ...
      .addCase(
        videoCodePrototypesSlice.actions.append,
        (state, action: PayloadAction<VideoCodePrototype>) => {
          if (!state.current) {
            return state
          }
...
const selectSolutionFromGroupPhase = createSelector(
  [selectById, (_, id?: SolutionId) => id],
  (byId, solutionId) => {
...
const selectCurrentSolutionFromGroupPhase = createSelector(
  [selectById, selectCurrentId],
  (byId, currentId) => {
