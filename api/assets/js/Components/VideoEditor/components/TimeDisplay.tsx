...
const TimeDisplay: FC<Props> = (props) => {
  const seconds = SecondsStringFormatter.format(
    getSecondsFromTimeSeconds(props.timeInSeconds)
  )
  const minutes = MinutesStringFormatter.format(
    getMinutesFromTimeSeconds(props.timeInSeconds)
  )
  const hours = HoursStringFormatter.format(
    getHoursFromTimeSeconds(props.timeInSeconds)
  )
