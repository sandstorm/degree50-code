export const fixtureState = {
            ...
            byId: {
                '969de546-8db4-44c4-a545-a529bbfb400f': {
                    solutionLists: {
                        ...
                        cutList: [],
                        videoCodePrototypes: ['83a8ba59-325d-47ec-8e36-dbb8becb6fd6', 'Lr_m3u2ZG'],
                    },
    ...
    config: {
        ...
        apiEndpoints: {
            updateSolution: '/exercise-phase/update-solution/728ebad7-b0b1-4067-8bb8-9004282b08ae',
            updateCurrentEditor: '/exercise-phase/update-current-editor/728ebad7-b0b1-4067-8bb8-9004282b08ae',
        },
