 ...
 */
final class Version20200602120440 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE material CHANGE exercise_phase_id exercise_phase_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
        ...
        $this->addSql('ALTER TABLE exercise_phase CHANGE belongs_to_excercise_id belongs_to_excercise_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', CHANGE components components LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exercise CHANGE course_id course_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE exercise_phase CHANGE belongs_to_excercise_id belongs_to_excercise_id CHAR(36) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:guid)\', CHANGE components components LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:simple_array)\'');
        $this->addSql('ALTER TABLE exercise_phase_team CHANGE solution_id solution_id INT DEFAULT NULL, CHANGE current_editor_id current_editor_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE material CHANGE exercise_phase_id exercise_phase_id CHAR(36) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:guid)\'');
