 ...
 */
final class Version20200527113334 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exercise_phase ADD is_group_phase VARCHAR(255) NOT NULL, CHANGE belongs_to_excercise_id belongs_to_excercise_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exercise CHANGE course_id course_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE exercise_phase DROP is_group_phase, CHANGE belongs_to_excercise_id belongs_to_excercise_id CHAR(36) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:guid)\'');
        $this->addSql('ALTER TABLE exercise_phase_team CHANGE solution_id solution_id INT DEFAULT NULL, CHANGE current_editor_id current_editor_id INT DEFAULT NULL');
