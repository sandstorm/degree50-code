 ...
 */
final class Version20200525092536 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exercise ADD description LONGTEXT NOT NULL, CHANGE course_id course_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exercise DROP description, CHANGE course_id course_id INT DEFAULT NULL');
