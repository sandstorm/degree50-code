 ...
 */
final class Version20200529091232 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE video_analysis (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE video_analysis ADD CONSTRAINT FK_A8B1F58CBF396750 FOREIGN KEY (id) REFERENCES exercise_phase (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE video_analysis_video ADD CONSTRAINT FK_6DFC18195BC3B19E FOREIGN KEY (video_analysis_id) REFERENCES video_analysis (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE video_analysis');
